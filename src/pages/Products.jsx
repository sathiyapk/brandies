...
export const Products = () => {
  return (
    ...
    {/* <video className='products-video'  autoPlay muted loop  >
        ...
        {/* Header Section */}
        <div className='bg-cepage-bg-img  w-full h-auto md:h-[600px] bg-cover bg-center bg-no-repeat  ' >
        ...
        {/* Cabernet */}
        <div className='bg-cepage-bg-odd  w-full h-auto  bg-cover bg-center bg-no-repeat  ' >
            <div className='bg-cepage-cabernet-icons  w-full h-auto bg-cover  bg-center bg-no-repeat ' >
              <div className='container mx-auto p-5 text-center '>
                  ...
                  <article class="text-wrap ">
                            ...
                            <div className=' grid grid-cols-1 gap-4 place-items-right pt-5'>
                                   <img className='w-full h-auto md:w-11/12'  src='../src/assets/images/carbanet-grapes.png' />
                              </div>
        ...
        {/* Le- Merlot */}
        <div className='bg-lemerlot-bg  w-full h-auto  bg-cover bg-center bg-no-repeat  ' >
              <div className='container mx-auto  text-center '>
                  <div className="grid grid-cols-1 md:grid-cols-2 ">
                  <div className=' grid grid-cols-1 place-items-left pt-5'>
                                   <img className='w-full h-auto md:w-11/12'  src='../src/assets/images/merlot-grapes.png' />
                              </div>
                                  <article class="text-wrap ">
        ...
        {/* Ugni-blanc */}
        <div className='bg-ugni-blanc-bg  w-full h-auto  bg-cover bg-center bg-no-repeat  ' >
        ...
        <div className='bg-baco-bg  w-full h-auto  bg-cover bg-center bg-no-repeat  ' >
              <div className='container mx-auto  text-center '>
                  <div className="grid grid-cols-1 md:grid-cols-2 ">
                  <div className=' grid grid-cols-1 place-items-left pt-5'>
        ...
        {/*  Chardonnay */}
        <div className='bg-chardonnay-bg  w-full h-auto  bg-cover bg-center bg-no-repeat  ' >
